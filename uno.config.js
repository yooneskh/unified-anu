...

    {
      ...
      shortcuts: [
        ...
        ],
        {
          ...
          'a-btn-icon-only': 'em:spacing:px-2 font-medium em:spacing:rounded-lg em:spacing:h-10 aspect-square em:spacing:min-w-10 uno-layer-base-i:em:[&_.a-btn-content]-text-lg focus-visible:ring-2 ring-offset-2',
          ...
          // added `!rounded-none` because ACard have rounded utility that override the `rounded-none`
